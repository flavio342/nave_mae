...
from core.dashboard_views.relatives.query import get_all, get_by_id
from core.dashboard_views.relatives.serializer import serialize, serialize_list
...
class DeleteRelatives(Resource):
